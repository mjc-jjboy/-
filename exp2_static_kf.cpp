...
// ------------------------ Experiments ------------------------
struct Options {
    string exp="kf_static"; // fixed to Experiment 2
    string obsPath;
    string navPath;
    char sys='A'; // 'A' all, 'G', 'C'
    int maxEpochs=200;
    string outPath="exp2_static_kf_report.txt";
};
;

static void printUsage(){
    cerr << "Usage: exp2_static_kf --obs <obs.rnx> --nav <nav.rnx>\n"
...
// Experiment fixed: Static EKF SPP
opt.exp = "kf_static";
